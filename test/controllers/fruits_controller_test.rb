...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create fruit' do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { description: @fruit.description, name: @fruit.name } }, as: :json
    end
  ...
  test 'should update fruit' do
    patch fruit_url(@fruit), params: { fruit: { description: @fruit.description, name: @fruit.name } }, as: :json
    assert_response 200
  end
